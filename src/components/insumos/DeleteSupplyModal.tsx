      ...
      <div className="bg-white rounded-3xl max-w-sm w-full shadow-2xl border border-neutral-100 p-5 sm:p-6 relative animate-in zoom-in-95 duration-200">
        ...
        {status === "checking" && (
          <div className="py-6 flex flex-col items-center text-center space-y-3">
            ...
            <div className="flex items-center gap-1.5 text-[#306236] text-[11px] font-semibold">
          ...
          <div className="flex flex-col text-center space-y-3 pt-1">
            ...
            <div className="bg-neutral-50 rounded-2xl p-2.5 border border-neutral-200/70 max-h-36 overflow-y-auto space-y-1.5 text-left">
              {blockingProducts.map((p) => (
                ...
                >
                  <div className="w-6 h-6 rounded-lg bg-[#e5f2e6] text-[#306236] flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex flex-col text-center space-y-3 pt-1">
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button
                ...
                className="flex-1 py-2.5 text-xs font-bold text-white bg-[#3b7c42] hover:bg-[#326b38] rounded-2xl transition shadow-sm flex items-center justify-center gap-1.5"
              >
