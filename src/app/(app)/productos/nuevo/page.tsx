...
const DEFAULT_CHANNELS = [
  { id: "pormenor", name: "Por Menor", defaultMargin: 100 },
  { id: "pormayor", name: "Por Mayor", defaultMargin: 50 },
];
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1 mr-2">
                      <div className="p-1.5 bg-white rounded-lg border border-neutral-200/80 shadow-2xs">
                        {getChannelIcon(channel.id)}
                      </div>
                      <div className="relative flex items-center flex-1 max-w-[240px] group">
                        <input
                          type="text"
                    ...
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      {channelPrices.length > 1 && (
                        <button
                          ...
                          title="Eliminar este canal de venta"
                        >
                  ...
                  <div className="space-y-1.5 bg-white p-2.5 rounded-xl border border-neutral-200/80">
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      <button
                        type="button"
                        onClick={() => {
                          const current = typeof channel.profit_margin_percent === "number" ? channel.profit_margin_percent : parseFloat(String(channel.profit_margin_percent)) || 0;
                          handleMarginChange(idx, Math.max(0, current - 5));
                        }}
                        className="px-2 py-1 bg-neutral-100 hover:bg-neutral-200 active:scale-95 border border-neutral-200 rounded-lg text-[11px] font-bold text-neutral-600 transition shadow-2xs select-none"
