...
export const UNIT_PRESETS: UnitPreset[] = [
  ...
  {
    id: "m2-cm2",
    name: "Metros cuadrados a Centímetros cuadrados (m2 → cm2)",
    category: "superficie",
    purchaseUnit: "m2",
    useUnit: "cm2",
    defaultFactor: 10000,
    example: "Ej: 1 m2 de tela, vinilo o madera = 10.000 cm2",
  },
  {
    id: "m2-m2",
    name: "Metros cuadrados directos (m2 → m2)",
    category: "superficie",
    purchaseUnit: "m2",
    useUnit: "m2",
    defaultFactor: 1,
    example: "Ej: Plancha de 1 m2 = 1 m2",
  },
  {
    id: "cm2-cm2",
    name: "Centímetros cuadrados directos (cm2 → cm2)",
    category: "superficie",
    purchaseUnit: "cm2",
    useUnit: "cm2",
    defaultFactor: 1,
    example: "Ej: Recorte o sticker de 100 cm2",
  },
  {
    id: "l-ml",
